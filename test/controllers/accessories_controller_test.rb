...
class AccessoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create accessory" do
    assert_difference("Accessory.count") do
      post accessories_url, params: { accessory: { cost: @accessory.cost, count: @accessory.count, name: @accessory.name } }
    end
  ...
  test "should update accessory" do
    patch accessory_url(@accessory), params: { accessory: { cost: @accessory.cost, count: @accessory.count, name: @accessory.name } }
